  ...
  if (isLoading) {
    return (
      <div className="dashboard-container">
        <p className="loading-text">Loading batch records...</p>
      </div>
    );
  }
              ...
              batches.map((batch) => {
                ...
                return (
                  <tr key={batch.id}>
                    ...
                    <td>
                      {getPropertyValue(batch.properties, 'Farmer Name')}
                    </td>
